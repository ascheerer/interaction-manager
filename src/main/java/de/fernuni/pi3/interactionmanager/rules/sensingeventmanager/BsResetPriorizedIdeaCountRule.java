...
@Service
public class BsResetPriorizedIdeaCountRule extends
	...
	protected boolean ruleCondition(Event in, Event out, InstanceVars var)
		...
		return (in.getName().equals("duration")
				...
				&& "priorization".equals(var.get("BRAINSTORMING_STEP")) && (getRequiredVar(
				var, "TEMP_PRIORIZED_IDEA_COUNT", Integer.class) > SensingEventManagerConsts.MIN_PRIORIZED_IDEA_COUNT));
	}
