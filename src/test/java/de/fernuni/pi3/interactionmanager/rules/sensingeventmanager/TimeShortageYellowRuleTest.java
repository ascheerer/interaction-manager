...
import de.fernuni.pi3.interactionmanager.rules.sensingeventmanager.TimeShortageYellowRule;

public class TimeShortageYellowRuleTest extends AbstractRuleTest {
	...
	public void setUpTestData() {
		...
		// test a: meeting time 790000 = 79% => colorchanger yellow expected
		// given
		...
		expectedEvent.setProperty("eventId", 30);
		expectedEvent.setProperty("type", "yellow");
		...
		addTestData(givenEvent, givenInstanceVars1, null,
				expectedInstanceVars1);
	}

	@Override
	protected Rule getRule() {
		return new TimeShortageYellowRule();
	}
}
